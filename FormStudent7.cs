...
namespace Klass
{
    public partial class FormStudent7 : Form
    {
        ...
        {
            Bitmap bmp = new Bitmap(students7DataGridView.Size.Width + 10, students7DataGridView.Size.Height + 10);
            students7DataGridView.DrawToBitmap(bmp, students7DataGridView.Bounds);
